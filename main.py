...
GROUP_ID = 229040854
TG_CHANNEL = "topor"
CHECK_INTERVAL = 60  т.е. проверка каждую минуту
    ...
    try:
        ...
        for url in media_urls[:10]:
            ...
            if att:
                ...
                time.sleep(0.4) # Пауза против лимитов ВК
...
def main():
    print("Бот запущен и следит за каналом...")
    # Первый прогон: собираем текущие ID, чтобы не спамить старьем при запуске
